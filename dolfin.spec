...
cmake -DCMAKE_PREFIX_PATH=/share/apps -DCMAKE_INSTALL_PREFIX=$RPM_BUILD_ROOT%{prefix} -DPYTHON_EXECUTABLE:FILEPATH=/usr/bin/python26 -DPYTHON_INCLUDE_PATH:PATH=/usr/include/python2.6/:/share/apps/ -DPYTHON_LIBRARY:FILEPATH=/usr/lib64/libpython2.6.so.1.0 -DUFC_DIR=/share/apps/ -DARMADILLO_DIR=/share/apps/ -DBLAS_LIBRARIES:PATH=/share/apps/lib/libatlas.a -DLAPACK_LIBRARIES:PATH=/share/apps/lib/liblapack.a -DUMFPACK_DIR=/share/apps/ .
make
